          ...
          <div class="row h-100 overflow-auto">
                ...
                <div class="col">
                  <div class="mb-5 mt-5">
                    ...
                    <p class="font-weight-bold text-dark">
                      Tienes {{quantityCart}} {{quantityCart == 1 ?'producto' :
                      'productos'}}
                    </p>
                  </div>
                </div>
                        ...
                        <div class="col-8">
                          <div class="row align-items-center">
                            <div class="col mt-n2 product-name">
                              <span
                                class="h6 text-capitalize font-weight-bold font-italic text-primary"
                              >{{item.name}}</span>
                            </div>
                            <div class="mt-n4">
                              <button
                          ...
                          <div class="row align-items-center">
                            <div class="col">
                              <div
                                class="input-group input-group-sm mr-2"
                                role="group"
                            ...
                            <div class="col-auto">
                              <span
                                class="h6 small font-weight-bold text-dark"
            ...
            <div class="col-12">
              <div class="row">
                <div class="col-12 mt-3 politicas">
                  ...
                  <p>Al momento de comprar tus productos ten en cuenta las siguientes recomendaciones:</p>
                  <ul>
                    <li>Compra minima de productos $15.000.</li>
                    <li class="text-primary">
                      Cuando el pago sea realizado por tarjeta de crédito o por PSE, enviar comprobante de pago al WhatsApp
                      <br />(+57 3113745588)
                    </li>
                    <li>Espera tus productos aproximadamente 1 hora y media después de realizado tu pago.</li>
                    <li>
                      Puedes realizar tus pedidos entre las 8:00 am y 6:00 pm. Si haces tu pedido por fuera de estos
                      horarios nos comunicaremos contigo al día siguiente y programaremos la hora de entrega.
                    </li>
                    <li>
                      Los Domingos y festivos también te llevamos tu domicilio pero nos comunicamos contigo para
                      programar la hora de entrega.
                    </li>
                    <li>
                      Si vives en la ciudad de Armenia el domicilio tendrá un costo de $1,500 para el centro 
                      y norte de la ciudad. Para el sur tendrá un costo de $3,000 
            ...
            <div class="col-12 border-top pt-4 bg-white align-self-end total position-fixed">
              <div class="row">
                <div class="col">
                  <span
                    class="font-italic d-block mb-2 font-weight-bold"
                    style="color:#CCCCCD;"
                  >Precio Total</span>
                ...
                <div class="col">
                  <span
                    :class="{'disabled':total<15000}"
                    @click="pagar"
                    class="btn btn-primary p-3 text-white font-italic font-weight-bold"
