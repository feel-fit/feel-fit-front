        ...
        <div class="col-12 col-md-6">
          <div class="h-100 align-items-center">
            <div class="card bg-white d-flex position-relative border-0">
              <v-lazy-image  class="card-img-top"
          ...
          <div class="row h-100">
            <div class="col-12">
              <div class="row d-md-none mt-4 mb-5 d-flex justify-content-between">
                <div class="col-6">
                  <span class="btn bg-white border shadow px-5 color_texto1" style="border-radius:1rem;">
                    <img src="../assets/images/fav.svg">&nbsp;&nbsp;Agregar</span>
                </div>
                <div class="col-6 text-center">
                  <span class="btn bg-info border shadow px-5 color_border">
            ...
            <div class="col-12 align-self-center">
              <div class="position-relative">
                ...
                <div class="row">
                  ...
                  <div class="col-6">
                    <p class="font-weight-bold text-dark text-right text-md-left mr-5 mr-md-0">{{product.price | money}}</p>
                  </div>
                </div>
                <p class="mt-5 color_texto2">{{product.description}}</p>
              </div>
            </div>
            <div class="col-12 mb-4 align-self-end">
              <div class="row">
                <div class="col-12 col-lg-3">
                  ...
                  <p v-for="item in product.categories" class="color_texto2">{{item.name}}</p>
                </div>
                <div class="col-12 col-lg-6">
                  <div class="ingre mb-3 ml-lg-2 pl-lg-4 pr-4 pt-3 pt-lg-0">
                    ...
                    <p v-for="item in product.tags" class="color_texto2">{{item.name}}</p>
                    <hr class="linea d-lg-none mt-0 color_border2">
                  </div>
                </div>
                <div class="col-12 col-lg-3">
